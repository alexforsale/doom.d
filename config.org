...
(setq org-use-property-inheritance t ;; warisi property dari header level sebelumnya
      org-return-follows-link t ; RET akan mengarahkan ke link
      ...
      org-refile-allow-creating-parent-nodes 'confirm ; perbolehkan node baru ketika refile
      )
  #+end_src
*** :term
**** vterm
...
#+begin_src emacs-lisp
(setq
      evil-want-fine-undo t; undo dilakukan dalam beberapa tahap
      undo-limit 80000000 ;80mb
      truncate-string-ellipsis "…"
      )
(display-time-mode 1); berguna kalau kita sering fullscreen
